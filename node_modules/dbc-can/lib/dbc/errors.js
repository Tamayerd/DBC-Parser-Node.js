...
exports.IncorrectFileExtension = exports.SignalDoesNotExist = exports.InvalidPayloadLength = exports.TokenError = exports.ParseError = exports.MessageDoesNotExist = exports.LineDoesNotContainToken = void 0;
...
class IncorrectFileExtension extends Error {
    constructor(message) {
        super(message);
        this.__proto__ = Error;
...
exports.IncorrectFileExtension = IncorrectFileExtension;
